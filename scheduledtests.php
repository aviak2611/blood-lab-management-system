                ...
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-md-12 my-4">
                            <h2 class="h4 mb-1">Scheduled Tests</h2>
                            <!-- <p class="mb-3">Child rows with additional detailed information</p> -->
                            <div class="card shadow scrolltable">
                                <div class="card-body">
                                    <!-- table -->
                                    <table class="table table-hover table-borderless border-v">
                                        ...
                                        <tbody>
                                            ...
                                            <tr id="collap-2474" class="in p-3 bg-light collapse">
                                                <td colspan="8">
                                            ...
                                            <tr class="accordion-toggle collapsed" id="c-3954" data-toggle="collapse" data-parent="#c-3954" href="#collap-3954" aria-expanded="false">
                                                <td>3954</td>
                                            ...
                                            <tr id="collap-3954" class="in p-3 bg-light collapse">
                                                <td colspan="8">
                                                    <dl class="row mb-0 mt-1">
                                                        <dt class="col-sm-1">Company</dt>
